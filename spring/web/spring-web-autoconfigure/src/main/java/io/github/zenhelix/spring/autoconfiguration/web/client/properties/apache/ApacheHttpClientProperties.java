...
public class ApacheHttpClientProperties extends AbstractHttpClientProperties {
    ...
    public ApacheHttpClientProperties() {
        super();
    ...
    public record SocketConfigProperties(
            @DurationMin(millis = 0)
            @DurationUnit(ChronoUnit.SECONDS)
            Duration soTimeout,
